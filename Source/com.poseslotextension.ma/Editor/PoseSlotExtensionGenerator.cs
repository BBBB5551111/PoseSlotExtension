...
namespace PoseSlotExtensionMAStable.Editor
{
    public static class PoseSlotExtensionGenerator
    {
        ...
        private const string Root = "Packages/com.poseslotextension.ma";
        ...
        private static void ValidateDependencies()
        {
            ...
            if (AssetDatabase.LoadAssetAtPath<GameObject>(maPrefab) == null &&
                ...
                throw new InvalidOperationException("BUDDYWORKS Poses Extension Packageが見つかりません。");
        }
        ...
        {
            // The prefab carries only the 150 saved slot values. The installer adds
